...
row.names(bbtab)<-c("$\\mu_{\\alpha}$","$\\mu_{temp}$","$\\mu_{mois}$",   
                    "$\\mu_{temp:mois}$")
colnames(bbtab)<- c("mean",'error',"25%", "75%","5%","95%","mean",'error',"Ngrps","mean",'error',"Ngrps","mean",'error',"Ngrps")
...
#add leafout
 ...
 lotab<-cbind(round(fixef(mod,probs = c(0.25,0.75,0.05, 0.95)), digits = 1),#fixed effects
  ...
  row.names(lotab)<-c("$\\mu_{\\alpha}$","$\\mu_{temp}$","$\\mu_{mois}$",   
                      "$\\mu_{temp:mois}$")
  colnames(lotab)<- c("mean",'error',"25%", "75%","5%","95%","mean",'error',"Ngrps","mean",'error',"Ngrps","mean",'error',"Ngrps")
...
row.names(fltab)<-c("$\\mu_{\\alpha}$","$\\mu_{temp}$","$\\mu_{mois}$",   
                    "$\\mu_{temp:mois}$")
colnames(fltab)<- c("mean",'error',"25%", "75%","5%","95%","mean",'error',"Ngrps","mean",'error',"Ngrps","mean",'error',"Ngrps")
