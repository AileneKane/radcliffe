...
\label{table:dtrtemp}
\begingroup\footnotesize
\begin{tabular}{|p{0.15\textwidth}|p{0.05\textwidth}p{0.05\textwidth}|p{0.05\textwidth}p{0.05\textwidth}|}
  \hline
  &\multicolumn{2}{c |}{min air temp.} &\multicolumn{2}{c |}{max soil temp.} \\
...
\begingroup\footnotesize
\begin{tabular}{|p{0.23\textwidth}|p{0.01\textwidth}|p{0.1\textwidth}p{0.07\textwidth}|p{0.1\textwidth}p{0.07\textwidth}|p{0.1\textwidth}p{0.07\textwidth}|}
  \hline
...
\begingroup\footnotesize
\begin{tabular}{|p{0.03\textwidth}|p{0.14\textwidth}|p{0.05\textwidth}p{0.04\textwidth}p{0.05\textwidth}p{0.06\textwidth}|p{0.05\textwidth}p{0.04\textwidth}p{0.05\textwidth}p{0.06\textwidth}|p{0.05\textwidth}p{0.04\textwidth}p{0.05\textwidth}p{0.06\textwidth}|}
  \hline
