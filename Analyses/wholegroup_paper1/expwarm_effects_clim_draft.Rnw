...
soilmnmod<-lmer(soiltemp1_mean~temptreat + (1|site), data=expclim_cont, REML=FALSE)
soilmimod<-lmer(soiltemp1_min~temptreat + (1|site), data=expclim_cont, REML=FALSE)
soilmxmod<-lmer(soiltemp1_max~temptreat + (1|site), data=expclim_cont, REML=FALSE)
airmnmod<-lmer(airtemp_mean~temptreat + (1|site), data=expclim_cont, REML=FALSE)
airmimod<-lmer(airtemp_min~temptreat + (1|site), data=expclim_cont, REML=FALSE)
airmxmod<-lmer(airtemp_max~temptreat + (1|site), data=expclim_cont, REML=FALSE)
...
print(xtabA,floating=FALSE, include.rownames = FALSE)
@
\par Summary of linear mixed effects model testing difference in mean air temperatures of structural controls compared with ambient controls (i.e.with no control chambers or warming infrastructure in place). The model included a fixed effect of control type and an intercept-only random effect of studysite to account for study and measurement, as well as environmental, differences.
\par
<<shamtable1, echo=FALSE,results=tex>>=
...
print(xtabS,floating=FALSE, include.rownames = TRUE)
@
\par Summary of linear mixed effects model testing difference in mean soil temperature (at the shallowest depth measured) of structural controls compared with ambient controls. The model included a fixed effect of control type and an intercept-only random effect of studysite to account for study and measurement, as well as environmental, differences.
\par
<<shamtable1, echo=FALSE,results=tex>>=
...
print(xtab3,floating=FALSE, include.rownames = FALSE)
@
\par Summary of linear mixed effects model testing difference in minimum air temperatures of structural controls compared with ambient controls (i.e.with no control chambers or warming infrastructure in place). The model included a fixed effect of control type and an intercept-only random effect of studysite to account for study and measurement, as well as environmental, differences.
\par
<<shamtable1, echo=FALSE,results=tex>>=
...
print(xtab4,floating=FALSE, include.rownames = FALSE)
@
\par Summary of linear mixed effects model testing difference in minimum soil temperature (at the shallowest depth measured) of structural controls compared with ambient controls. The model included a fixed effect of control type and an intercept-only random effect of studysite to account for study and measurement, as well as environmental, differences.
\par
<<shamtable1, echo=FALSE,results=tex>>=
xtab5<-xtable(airmxtable,digits=3,caption="Summary of linear mixed effects model testing difference in maximum air temperatures of structural controls compared with ambient controls (i.e.with no control chambers or warming infrastructure in place). The model included a fixed effect of control type and an intercept-only random effect of studysite to account for study and measurement, as well as environmental, differences.")

print(xtab5,floating=FALSE, include.rownames = FALSE)
@
\par Summary of linear mixed effects model testing difference in maximum air temperatures of structural controls compared with ambient controls (i.e.with no control chambers or warming infrastructure in place). The model included a fixed effect of control type and an intercept-only random effect of studysite to account for study and measurement, as well as environmental, differences.
\par
<<shamtable1, echo=FALSE,results=tex>>=
...
print(xtab6,floating=FALSE, include.rownames = FALSE)
@
\par Summary of linear mixed effects model testing difference in maximum soil temperature (at the shallowest depth measured) of structural controls compared with ambient controls. The model included a fixed effect of control type and an intercept-only random effect of studysite to account for study and measurement, as well as environmental, differences.
\par
\section* {Figures}
