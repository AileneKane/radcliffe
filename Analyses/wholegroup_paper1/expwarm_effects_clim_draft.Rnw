...
\author{A.K. Ettinger,I. Chuine, B. Cook, J. Dukes, A.M. Ellison, M. Johnston, A.M. Panetta,\\ C. Rollinson, Y. Vitasse, E. Wolkovich}
%\date{\today}
...
\par Future climate change is expected to cause dramatic alterations to Earth's biota. The physiology, distribution, and abundance of organisms will shift, and likely cause cascading community and ecosystem effects \citep{thomas2004,parmesan2006,sheldon2011,urban2012}. Much uncertainty remains, however, about how particular individuals, populations, communities, and ecosystems will respond. These uncertainties make predicting ecological responses to the climate change one of the most significant challenges facing biology today.%From Yann:biologist or ecologist? We may add here the impact of such changes on feedbacks of such responses for biodiversity, CO2, biogeochemical cycles and therefore on feedback to earth' climate (if it's planned for Nature Climate Change, I think we have to add this dimension that biologists try to predict responses of ecosystems to climate change in order to better assess feedbacks on earth' climate and ecosystem services, isn't it right?)
...
%CRR: I think before going to the experments paragraph, it's probably worth elaborating why we use experiments and why observation-only & model-based studies aren't enough.  I think the key point to highlight here is that in observation-based studies it's extremely difficult to disentangle the causal effect of warming on plant dynamics from other background processes like land use change, succession, N. deposition, etc..  I think it's safe to say that active expermints are teh only way that let us test causal effects of climate change, and particularly at the scales of physiological response to warming.  Experiments also help us create combinations of climate & vegetation that currently have no analog on the landscape.  (Update: Now I see you cover a lot of these points in 2 paragraphs down; I'd think I'd put why experiments are useful before talking about some of the actual approaches)

\par One major way to understand and forecast future biological conditions is through in situ experimental climate manipulations. Most of these studies have focused on manipulations to replicate higher temperatures. Commonly used field techniques for this include passive warming, such as open-top chambers, and active warming methods, including forced air, soil cables, and infra-red radiation. Passive warming methods have the benefits of being easy to deploy and relatively inexpensive, making it possible to set them up in more remote and challenging-to-access areas. ADD drawbacks of passive warming methods like the OTC, mainly the side effects but also that warming is acting only during bright days.%It is then even more justifiable that we focus on active warming methods only. 
...
% CRR: If you move "why we use experiments" to above this, you can maybe use this to talk about the pros & cons of these different approaches and how they have different implicit assumptions about what kind of warming is most important.  Maybe that would help start funneling to the question of what type of climate change are these experiments replicating?
...
Temperature, for example, interacts with precipitation to alter the abiotic environment; Rollinson et al (2012) observed that a twenty percent increase in precipitation reduced mean hourly temperatures by 0.3 degrees Celsius over the course of their two-year experiment. % CRR: The better citation for this would be McDaniel et al 2014 Theoretical & Applied Climatorlogy -- that's where we explicitly look at microclimate effects.  The 2012 paper notes the ecological significance of that on phenology, but the 2014 paper goes into these kind of effects in much greater detail
...
heat shock proteins change in response to warming  \citep{Stanton-Geddes2016}
Decomposition and soil carbon dynamics shift with IR heating and soil warming\citep{Del Toro2015}. 
...
citations: all the previously cited ant work, 3-5years. Mellilo experiments on soil warming are > 20 years now. His are key papers to cite. % CRR -- there are a couple papers lately I think supporting the importance of LTERs which I think are related
