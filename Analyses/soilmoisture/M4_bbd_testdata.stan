...
// Levels: Species (random slopes for temp and sm), and site yet (random intercepts for site, atleast for now). These random effects are crossed, for now. 
...
parameters {
  ...
  real mu_a_site;
  //real mu_b_temp_site;  //not using letting slopes vary by site for now 
  //real mu_b_mois_site;
