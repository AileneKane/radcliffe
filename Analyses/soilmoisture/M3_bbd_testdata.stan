...
// Levels: Species (with random slopes and interecepts for temp and sm and their interaction)
...
parameters {
  ...
  //real mu_a_site;
  //real mu_b_temp_site;  //not letting slopes vary by site for now 
  //real mu_b_mois_site;
  ...
  real b_tm[n_sp]; // slope of temp x mois effect for species
