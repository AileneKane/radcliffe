...
applied) and ambient controls with no infrastructure added. These five studies occurred at two sites: Duke Forest and Harvard Forest (Farnsworth et al., 1995; Clark
et al., 2014a; Marchin et al., 2015; Pelini et al., 2011).
We fit linear mixed effect models with mean daily soil temperature, minimum daily air temperature, and maximum daily air temperature as reponse variables (Figure 3 in the main text).
...
soil (Figure 4a,b). This general pattern was consistent across the dierent temperature models we t (mean,
minimum, and maximum temperatures), although the magnitude varied across seasons (Figure 4a,b), as well
as among studies, years, and with ambient temperature (Table XS). In addition, soil moisture was lower in
structural controls compared with ambient conditions (Figure 4c).
...
expclim<-read.csv("expclim.csv", header=T)
  ...
  caption="Temporal linear mixed-effects model for daily mean soil temperature, minimum above-ground temperature, and maximum above-ground temperature.",label="table:blocks_time",align=c(
               "p{0.01\\textwidth}|",
                "|p{0.23\\textwidth}",
               "|p{0.12\\textwidth}",
               "p{0.01\\textwidth}",
  ...
  caption="Spatial linear mixed-effects model for daily mean soil temperature, minimum above-ground temperature, and maximum above-ground temperature.",label="table:blocks_space",align=c(
               "p{0.01\\textwidth}|",
                "|p{0.23\\textwidth}",
               "|p{0.12\\textwidth}",
               "p{0.01\\textwidth}",
