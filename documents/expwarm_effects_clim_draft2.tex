...
\author[3]{B.I. Cook}
\author[4]{ J.S. Dukes}
\author[5]{A.M. Ellison}
\author[6]{M.R. Johnston}
\author[7]{A.M. Panetta}
\author[8]{C.R. Rollinson}
\author[9]{Y. Vitasse}
...
\affil[4]{Department of Forestry and Natural Resources
and Department of Biological Sciences, Purdue University, West Lafayette, Indiana, 47907, USA}
\affil[5]{Harvard Forest,Harvard University, Petersham, Massachusetts, 01366 , USA}
\affil[6]{Department of Organismic and Evolutionary Biology, Cambridge, Massachusetts 02138, USA}
\affil[7]{Department of Ecology and Evolutionary Biology, University of Colorado, Boulder, Colorado, 80309, USA}
\affil[8]{The Morton Arboretum, Lisle, Illinois 60532, USA}
\affil[9]{Institute of Geography, University of Neuch\^atel,Neuch\^atel, Switzerland}
