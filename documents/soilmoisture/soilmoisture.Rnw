...
\begin{enumerate}
\item{How do warming and precip treatments affect soil moisture?}
\item{Do warming treatments affect soil moisture similarly to warming in observational studies?}
...
\ite{Fit models of soil moisture as a function of temperature and precipitation treatments.}
...
\item{Compile Duke and Harvard Forest long-term phenology and climate data.}
