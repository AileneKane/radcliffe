...
\section* {DISCUSSION}
\par  Across the ecosystems included in the ExPhen database, soil moisture affects phenology, budburst, and  leaf-out. Soil moisture had previously been investigated primarily in grassland ecosystems (e.g. XXX), and has not been a focus of experiments and meta-analyses (e.g. Wolkovich). We quantify effects of soil moisture across forest, grassland, other ecosystems.
-Show estimated effects by manipulating posterios by biome?
-group species by biome and show 
-3 biomes- histograms of effects of oil moisture across species of different 
...
\centering
 ...
 %1. Figures
    % Make 
 %2. Reach out to Christy and Jeff when the figures are done and be clear that 
