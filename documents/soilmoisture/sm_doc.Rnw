...
probably worth mentioning lots of work on soil moisture from snowpack systems somewhere \citep[e.g.,][]{dunne2004,sherwood2017}
...
\citep{tao2020} "However, effects of precipitation and soil moisture on BBD varied among [herbacous] species [in Inner Mongolia grassland]." ... "correlations between BBD and SM were negative, suggesting that greater soil moisture
...
\cite{cabon2020} Good paper to cite for temperature and moisture being co-limiting
