...
\par We found that both higher soil moisture and higher temperatures advance phenology, meaning two common effects of warming experiments---soil drying and warming---have contrasting effects on phenology. Soil drying delays phenology and warming temperatures advance phenology. For budburst, wetter soils and warmer temperatures alone advanced phenology by \Sexpr{soileff.bbcent} (\Sexpr{soileff.bbcent.lci},\Sexpr{soileff.bbcent.uci}) per SD of soil moisture  (or \Sexpr{soileff.bb/10} days per 10 percent increase in volumetric water content) and \Sexpr{tempeff.bbcent} (\Sexpr{tempeff.bbcent.lci},\Sexpr{tempeff.bbcent.uci}) per SD of temperature (or \Sexpr{tempeff.bb} per degree Celsius). We did not find evidence of strong interactive effects of soil moisture and temperature on phenology: together, wetter and warmer conditions delayed budburst only a small amount (interaction effect of \Sexpr{inteff.bbcent} [\Sexpr{inteff.bbcent.lci}-\Sexpr{inteff.bbcent.uci}] per SD or \Sexpr{inteff.bb} natural units). 

\par The magnitude of soil moisture effects varied across phenophases, with effects on budburst (\Sexpr{soileff.bbcent} [\Sexpr{soileff.bbcent.lci},\Sexpr{soileff.bbcent.uci}]) being stronger than those on leafout (\Sexpr{soileff.locent} [\Sexpr{soileff.locent.lci},\Sexpr{soileff.locent.uci}] per SD of soil moisture) and flowering (\Sexpr{soileff.flcent} [\Sexpr{soileff.flcent.lci},\Sexpr{soileff.flcent.uci}] per SD). Similar to budburst, temperature effects were stronger than soil moisture for leafout (for which the temperature effect was \Sexpr{tempeff.locent} [\Sexpr{tempeff.locent.lci},\Sexpr{tempeff.locent.uci}] per SD) and flowering (for which it was \Sexpr{tempeff.flcent} [\Sexpr{tempeff.flcent.lci},\Sexpr{tempeff.flcent.uci}] per SD), across all species (Fig \ref{fig:bblofl}). Estimates of interactions between soil moisture and temperature on phenology also varied by phenophase, with weakly positive or no interactive effects estimated for leafout (\Sexpr{inteff.locent}) [\Sexpr{inteff.locent.lci},\Sexpr{inteff.locent.uci}] and budburst (\Sexpr{inteff.bbcent} [\Sexpr{inteff.bbcent.lci},\Sexpr{inteff.bbcent.uci}]) and a stronger but negative interaction for flowering (\Sexpr{inteff.flcent} [\Sexpr{inteff.flcent.lci},\Sexpr{inteff.flcent.uci}]). This negative interaction implies that there may be synergistic effects of soil moisture and temperature (both of which also have negative estimated effects on flowering), resulting in flowering that advances even more strongly than would be expected by simply adding together the  estimated effects of temperature and  moisture each acting alone. 

\par These overall effects varied widely across species (Fig \ref{fig:bblofl}). Species-level variance for the effect of moisture was \Sexpr{sdsoileff.bbcent} (\Sexpr{sdsoileff.bbcent.lci},\Sexpr{sdsoileff.bbcent.uci}) standardized units for budburst, \Sexpr{sdsoileff.locent} (\Sexpr{sdsoileff.locent.lci},\Sexpr{sdsoileff.locent.uci}) for leafout, and \Sexpr{sdsoileff.flcent} (\Sexpr{sdsoileff.flcent.lci},\Sexpr{sdsoileff.flcent.uci}) for flowering. Species-level variance was even greater for temperature effects: \Sexpr{sdtempeff.bbcent} (\Sexpr{sdtempeff.bbcent.lci},\Sexpr{sdtempeff.bbcent.uci}) for budburst, \Sexpr{sdtempeff.locent} (\Sexpr{sdtempeff.locent.lci},\Sexpr{sdtempeff.locent.uci}) for leafout, and \Sexpr{sdtempeff.flcent} (\Sexpr{sdtempeff.flcent.lci},\Sexpr{sdtempeff.flcent.uci}) for flowering. 
