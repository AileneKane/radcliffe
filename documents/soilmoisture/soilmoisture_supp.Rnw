...
source("../../Analyses/make_tablephensm.R")
 addtorow <- list()
  addtorow$pos <- list(-1)
  addtorow$command <- c("\\hline & \\multicolumn{6}{c |}{Population-Level Effects} &\\multicolumn{3}{c |}{Site Effects} &\\multicolumn{3}{c |}{Site Year Effects}&\\multicolumn{3}{c |}{Species Effects}\\\\\n ")
