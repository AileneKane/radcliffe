...
mod.table <- xtable(bbmod, caption="\\textbf{Summaries of budburst, leafout, and flowering models}.", label="tab:mods",align=c(
...
print(mod.table, include.rownames=FALSE, ,caption.placement="top",)
@
...
\centering
 ...
 \caption{\textbf{Effects of temperature, soil moisture, and their interaction do not differ strongly across ecosystem (forest vs grassland)}.}
 \label{fig:forms}
 \end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}
