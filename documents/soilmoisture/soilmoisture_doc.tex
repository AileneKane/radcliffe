...
\section* {Main}
\par Climate change is affecting organisms by altering temperature, precipitation, and soil moisture around the world \citep{parmesan2006,chen2010}. One of most widespread biological responses to climate change is a shift in phenology, the timing of recurring biological events, which has ocurred at rates of 2.3-5.1 days per decade \citep{parmesan2006,poloczanska2013,root2003}. Shifts in plant phenology are the most widely documented, with spring phenology (budburst, leaf-out, and flowering) occuring earlier in recent years \citep{wolkovich2012}, and senescence occuring later (citation). 
