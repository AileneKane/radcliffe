...
\label{tab:warmtech}
\begin{tabular}{|p{0.08\textwidth}|p{0.08\textwidth}|p{0.10\textwidth}|}
  \hline
...
\caption{\textbf{Comparison of coefficients from budburst models fit to data from all plots versus control plots only}.} 
\label{tab:warmtech}
\begin{tabular}{|p{0.08\textwidth}|p{0.08\textwidth}|p{0.08\textwidth}|p{0.08\textwidth}|p{0.10\textwidth}|}
  \hline
