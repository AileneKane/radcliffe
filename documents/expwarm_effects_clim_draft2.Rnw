...
% EMW: Would be stronger to add a citation with the wolkovich2012, maybe this one: http://onlinelibrary.wiley.com/doi/10.1890/ES13-00234.1/full
...
% EMW: I took out your references to mean temperatures, beyond the abstract you have not yet introduced the reader to this (you do it next, which seems fine, but you should not reference it here then). 
...
% EMW: Added in some active voice. 
...
% EMW: Changes below, see what you think. 
...
% EMW: Small tweaks below through to figures ... not all noted with %EMW comment!
...
\section* {Conclusions}
% EMW: I like the new conclusions! I think the last sentence is an unnecessary mouthful though -- I am not sure we need it and suggest just cutting it, depending on how you feel. I tried to move some of the mechanistic point up higher, which I hope also helps with what felt like a tricky transition. An alternative option might be this for a last sentence: We hope this provides a foundation for gaining the most knowledge from existing experiments, designing better experiments and models in the future (see Box 1), and for improved understanding of biological responses and feedbacks in a changing world.
...
% EMW: I don't really feel like I wrote the paper, see suggested changes. 
