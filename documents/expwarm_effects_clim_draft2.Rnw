...
\author[1]{A.K. Ettinger}
\author[2]{I. Chuine}
\author[3][4]{B.I. Cook}
\author[5]{J.S. Dukes}
\author[6]{A.M. Ellison}
\author[7]{M.R. Johnston}
\author[8]{A.M. Panetta}
\author[9]{C.R. Rollinson}
\author[10]{Y. Vitasse}
\author[1]{E.M. Wolkovich}

\affil[1]{Arnold Arboretum of Harvard University, Boston, Massachusetts, 02131, USA}
\affil[2]{CEFE UMR 5175, CNRS, Universit\'e de Montpellier,Universit\'e Paul-Val\'ery Montpellier, EPHE, Montpellier, France}
\affil[3]{Lamont-Doherty Earth Observatory, Columbia University, Palisades, New York, 10964, USA}
\affil[4]{NASA Goddard Institute for Space Studies, New York, NY, 10025, USA}
\affil[5]{Department of Forestry and Natural Resources
and Department of Biological Sciences, Purdue University, West Lafayette, Indiana, 47907, USA}
\affil[6]{Harvard Forest,Harvard University, Petersham, Massachusetts, 01366 , USA}
\affil[7]{Department of Organismic and Evolutionary Biology, Cambridge, Massachusetts 02138, USA}
\affil[8]{Department of Ecology and Evolutionary Biology, University of Colorado, Boulder, Colorado, 80309, USA}
\affil[9]{The Morton Arboretum, Lisle, Illinois 60532, USA}
\affil[10]{Institute of Geography, University of Neuch\^atel,Neuch\^atel, Switzerland}
