...
rownames(moistargtable)<-c("intercept (infrared)","intercept (forced air)","intercept (forced air and soil)","warmtreat (infrared)","warmtreat (forced air)","warmtreat(forced air and soil)")
