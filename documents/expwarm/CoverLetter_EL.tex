...
% EMW: Try to cut a sentence within next two paragraphs if you can, feels a little long (but okay to leave if you like).
...
For over three decades, ecologists have relied on field climate change experiments to understand and forecast ecological impacts of climate change. These experiments are still prevalent and used across diverse sub-disciplines  (1,2) % reich2015 %\citep{barton2009},  
