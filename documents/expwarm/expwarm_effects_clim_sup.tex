...
\begin{tabular}{|p{0.20\textwidth}|p{0.20\textwidth}|p{0.10\textwidth}|p{0.10\textwidth}|}
 ...
 & fixed effect & est. & se \\ 
  \hline
1 & (Intercept) & 110.14 & 7.02 \\ 
  2 & target & -1.95 & 0.08 \\ 
  3 & (Intercept) & 145.52 & 5.19 \\ 
   \hline
4 & agtmin_rel & -6.07 & 0.41 \\ 
  5 & soilmois_janmar & -132.77 & 11.22 \\ 
   \hline
6 & agtmin_rel:soilmois_janmar & 16 & 1.82 \\ 
  \end{tabular}
\endgroup
\end{table}