...
temperature type & forced air & force air, soil cables & infrared & soil cables & passive otc \\ 
  \hline
target (min-max) & 3.5 (1.5-5.5) & 4 (3-5) & 2.2 (1-4) & 5 (5-5) &   \\ 
  air\_mean (se) & 3.22 (0.12) & 1.9 (0.24) & 1.08 (0.16) &  & 0.8 (0.1) \\ 
  air\_range & 0.83-5.2 & -0.05-3.59 & 0.42-1.83 &  & 0.5-1.3 \\ 
  surf\_mean (se) &  &  & 1.72 (0.1) &  & 0.9 (0.1) \\ 
  surf\_range &  &  & 1.52-1.87 &  & 0.4-1.4 \\ 
  soil\_mean (se) & 1.29 (0.09) & 3.01 (0.34) & 1.73 (0.2) & 5.04 (NA) & 0.8 (0.3) \\ 
  soil\_range & -0.93-3.46 & 0.02-5.08 & -0.06-4.31 &   & -0.1-3.9 \\ 
  n & 2 & 2 & 9 & 1 & 0* \\ 
   \hline
\end{tabular}
\endgroup
