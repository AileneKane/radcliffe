...
\par We are sorry the reviewer feels we were inconsistent. We have tried to focus on significant results throughout the manuscript. We do use a single case study of budburst phenology as an example of how measured microclimate data, rather than target warming treatment, \emph{may} affect our interpretation of temperature sensitivity. We do not wish to give the impression that we think similar effects will occur with \emph{all} biological responses to experimental warming. However, the effects of soil moisture and measured warming on budburst are statistically significant, and we used all available relevant data from the database in this analysis (i.e., the analysis includes 4 studies- all the studies with soil moisture, above-ground temperature, and budburst phenology data). We have tried to be consistent and true to the data and analytical results  throughout the manuscript.  
