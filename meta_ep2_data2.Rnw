...
We extracted daily temperature data from gridcells encompassing each observational study site from Berkeley Earth Surface Temperatures \url{http://berkeleyearth.org/}.
